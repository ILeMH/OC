                          ...
                          <div class="imgwrap">    
                              <div class="icon_wrap animated fadeInUp">
                                	<a class="imgzoom" href="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'full'); echo $image[0]; ?>" title="<?php esc_attr_e('Preview','optimizer'); ?>" data-title="<?php the_title(); ?>"><i class="fa fa-search"></i></a>
                              		...
                              		<a href="<?php the_permalink();?>" title="<?php esc_attr_e('Lire plus','optimizer'); ?>"><i class="fa fa-plus"></i></a>
                              </div>                 
			...
			<div class="lay4_wrap_ajax">
                ...
                <!--POST THUMBNAIL START-->
                 ...
                 <!--POST THUMBNAIL END-->
                    ...
                    <!--POST CONTENT END-->
					<!--Lire plus Button-->
                    <div class="blog_mo"><a href="<?php the_permalink();?>">+ <?php _e('Lire plus', 'optimizer'); ?></a></div>
